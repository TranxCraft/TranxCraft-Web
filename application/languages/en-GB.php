...
/**
 * Texts used by the site. Currently it's a bit impractical to add different languages, so for now, we'll stick with english.
 * These texts are used via Text::get('FEEDBACK_USERNAME_ALREADY_TAKEN').
 * Could be extended to i18n etc.
 * A lot of these will change, there is some basic functionality to work around as a starting point...
 */
return array(
