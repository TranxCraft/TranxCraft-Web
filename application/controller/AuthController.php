<?php
// I MAY CHANGE THIS ENTIRE CONTROLLER TO "USER" INSTEAD OF "LOGIN". SOUNDS BETTER.
...
class AuthController extends Controller {
    ...
    /**
     * Index, default action (shows the login form), when you do auth/sign_in
     */
    public function index() {
        ...
        if (LoginModel::isUserLoggedIn()) {
			...
			$this->View->renderWithoutHeaderAndFooter('auth/signin/index');
        }
    }

    /**
     * The login action, when you do sign_in/index
     */
