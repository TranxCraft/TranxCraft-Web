...
return array(
	 ...
	 * Another, better and up-to-date implementation might come soon....Doubt it though, might just remove this tbh...
	 */
	 ...
	 * EMAIL_SMTP_AUTH: leave this true unless the SMTP service does not need authentication
	 */
	...
	/**
	 * Configuration for: Email content data (Thinking of moving this to the database for adminCP config)
	 */
	'EMAIL_PASSWORD_RESET_URL' => 'login/verifypasswordreset', // current URL.
	'EMAIL_PASSWORD_RESET_FROM_EMAIL' => 'no-reply@example.com',
	'EMAIL_PASSWORD_RESET_FROM_NAME' => 'Zero Decryption',
	'EMAIL_PASSWORD_RESET_SUBJECT' => 'Password reset for ZD',
	...
	'EMAIL_VERIFICATION_FROM_NAME' => 'Zero Decryption',
	'EMAIL_VERIFICATION_SUBJECT' => 'Account activation for ZD',
